...
**This Repo takes us through setting up a reverse proxy**
...
## Problems Faced
* What I Expect?
    - To see a working app that is listening on port 80
* What I Am Getting?
    - A working app still working on port 3000
* What I Think is Wrong?
    - I think there is a problem with the way nginx is restarting (`sudo systemctl restart nginx.service`)
